...
if(isset($_POST['submit']))
  {
    ...
    $sql ="SELECT emailAddr FROM tbladmin  WHERE Email=:email and MobileNumber=:mobile";
...
<body class="bg-dark" style=" background-image: url('images/systemImage/home_banner3.jpg');">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                      <h3 style="color:#ff9;"> UPASTHIT</h3>
                    <hr  color="red"/>
                </div>
